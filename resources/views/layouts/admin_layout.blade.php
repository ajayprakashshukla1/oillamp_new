  ...
  <section class="all-page-title">
    <div class="container-fluid">
      <div class="row custom-titele">
        <div class="col-sm-12">
        <ul>
          <li class="curent-page"><a href="#">Hi Admin</a></li>
  ...
  <section class="mid-sections">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="inner-mid-left-profile">
            <ul>
              <li class="active-menu"><a href="{{url('/admin/dashboard')}}"><img src="{{url('public/assets/images/active-icon1.png')}}"/> Dashboard <i class="fa fa-chevron-right" aria-hidden="true"></i></a></li>

              <li><a href="{{url('/admin/add_sticker')}}"><img src="{{url('public/assets/images/pen.png')}}"/>Add Sticker <i class="fa fa-chevron-right" aria-hidden="true"></i></a></li>

              <li><a href="{{url('/admin/list_sticker')}}"><img src="{{url('public/assets/images/pen.png')}}"/>List Sticker <i class="fa fa-chevron-right" aria-hidden="true"></i></a></li>
